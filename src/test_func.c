...
/*
 ...
 SEXP C_test_functions_with_example(){
	...
	*k = 2;
	...
	old_log_subperms[cord_spec(2,0,(n+1))] = log(20.0);

	Rprintf("start matrix:\n");
	...
	reverse_bt(old_log_subperms, new_log_subperms, 1,  0,
	...
	reverse_lm(old_log_subperms, new_log_subperms, 4,  1,
				alpha, beta,  gamma,  log_factorials, n, m, 
				temp_vec, k);
	print_matrix(n+1, n+1, new_log_subperms);
	Rprintf("Vectors:\n Alpha: ");
	...
	print_matrix(n+1, n+1, new_log_subperms);
	reverse_bs(old_log_subperms, new_log_subperms, 1,  0,
				alpha, beta,  gamma,  log_factorials, n, m, 
				temp_vec, k);
	print_matrix(n+1, n+1, new_log_subperms);
	Rprintf("Vectors:\n Alpha: ");
	...
	Rprintf("new matrix before update:\n");
	print_matrix(n+1, n+1, new_log_subperms);
	reverse_tt(old_log_subperms, new_log_subperms, 1,  0,
				alpha, beta,  gamma,  log_factorials, n, m, 
				k);
	Rprintf("RESULT:\n");
	print_matrix(n+1, n+1, new_log_subperms);
	...
	Rprintf("new matrix before update:\n");
	print_matrix(n+1, n+1, new_log_subperms);
	reverse_rm(old_log_subperms, new_log_subperms, 1,  1,
				alpha, beta,  gamma,  log_factorials, n, m, 
				temp_vec,k);
	Rprintf("RESULT:\n");
	print_matrix(n+1, n+1, new_log_subperms);
	...
	Rprintf("new matrix before update:\n");
	print_matrix(n+1, n+1, new_log_subperms);
	reverse_ts(old_log_subperms, new_log_subperms, 1,  1,
				alpha, beta,  gamma,  log_factorials, n, m, 
				temp_vec,k);
	Rprintf("RESULT:\n");
	print_matrix(n+1, n+1, new_log_subperms);
	...
	Rprintf("new matrix before update:\n");
	print_matrix(n+1,n+1, new_log_subperms);
	reverse_lm(old_log_subperms, new_log_subperms, 1,  3,
				alpha, beta,  gamma,  log_factorials, n, m, 
				temp_vec,k);
	Rprintf("RESULT:\n");
	print_matrix(n+1,n+1, new_log_subperms);
	...
	Rprintf("new matrix before update:\n");
	print_matrix(n+1, n+1, new_log_subperms);
	reverse_bs(old_log_subperms, new_log_subperms, 1,  3,
				alpha, beta,  gamma,  log_factorials, n, m, 
				temp_vec,k);
	Rprintf("RESULT:\n");
	print_matrix(n+1, n+1, new_log_subperms);
